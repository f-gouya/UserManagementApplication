...
class ProfileFrame(Frame):
    def __init__(self, window, view):
        ...
        self.firstname_label.grid(row=1, column=0, pady=(0, 10), padx=20, sticky="w")

        self.current_user_firstname_label = Label(self)
        self.current_user_firstname_label.grid(row=1, column=1, pady=(0, 10), padx=20, sticky="w")

        self.lastname_label = Label(self, text="Last Name")
        self.lastname_label.grid(row=2, column=0, pady=(0, 10), padx=20, sticky="w")

        self.current_user_lastname_label = Label(self)
        self.current_user_lastname_label.grid(row=2, column=1, pady=(0, 10), padx=20, sticky="w")

        self.username_label = Label(self, text="Username")
        self.username_label.grid(row=3, column=0, pady=(0, 10), padx=20, sticky="w")

        self.current_user_username_label = Label(self, text="Username")
        self.current_user_username_label.grid(row=3, column=1, pady=(0, 10), padx=20, sticky="w")
